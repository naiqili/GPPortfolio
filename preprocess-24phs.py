...
end_dates = ['2014-10-15', '2014-12-26', '2015-03-11', '2015-05-21', '2015-08-03', '2015-10-13', '2015-12-23', '2016-03-08', '2016-05-18', 
             '2016-07-29', '2016-10-10', '2016-12-20', '2017-03-06',
             '2017-05-16', '2017-07-26', '2017-10-05', '2018-01-25', '2018-04-09', '2018-06-19', '2018-08-29', 
             '2018-11-08', '2019-01-24', '2019-03-06', '2019-05-16']
...
for phs in range(0, len(end_dates)):
    ...
    np.savez('./stock_data/stock24_phase%02d_lb%d' % (phs, win), rt_trainx=cp_trainx, rt_trainy=cp_trainy,  \
